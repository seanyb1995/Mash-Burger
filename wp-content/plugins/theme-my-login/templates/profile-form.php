...
<div class="tml tml-profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile', 'login_post' ); ?>" method="post">
		...
		<tr class="tml-user-login-wrap">
			<th><label for="user_login"><?php _e( 'Username - cannot be changed', 'theme-my-login' ); ?></label></th>
		...
		<tr class="tml-rates-wrap">
			<th><label for="rates"><?php _e( 'Membership & Rates', 'theme-my-login' ); ?></label></th>
			<td><input type="text" name="rates" id="rates" disabled="disabled"  value="<?php echo esc_attr( $profileuser->rates ); ?>" class="regular-text" /></td>
		</tr>   
